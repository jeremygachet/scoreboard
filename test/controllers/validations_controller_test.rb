...
class ValidationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create validation" do
    assert_difference('Validation.count') do
      post validations_url, params: { validation: { exo: @validation.exo, team: @validation.team } }
    end
  ...
  test "should update validation" do
    patch validation_url(@validation), params: { validation: { exo: @validation.exo, team: @validation.team } }
